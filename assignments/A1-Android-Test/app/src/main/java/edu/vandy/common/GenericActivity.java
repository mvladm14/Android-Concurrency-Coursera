...
public abstract class GenericActivity<RequiredViewOps,
                                      ...
                                      PresenterType extends edu.vandy.common.PresenterOps<RequiredViewOps>>
       extends edu.vandy.common.LifecycleLoggingActivity
       implements edu.vandy.common.ContextView {
    /**
     * Used to retain the ProvidedPresenterOps state between runtime
     * configuration changes.
     */
    private final edu.vandy.common.RetainedFragmentManager mRetainedFragmentManager
        = new edu.vandy.common.RetainedFragmentManager(this.getFragmentManager(),
                                      TAG);
     ...
     */
    public edu.vandy.common.RetainedFragmentManager getRetainedFragmentManager() {
