...
public class PalantiriManager {
     ...
     */
    protected HashMap<edu.vandy.model.Palantir, Boolean> mPalantiriMap;

    /**
     * Constructor creates a PalantiriManager for the List of @a
     * palantiri passed as a parameter and initializes the fields.
     */
    public PalantiriManager(List<edu.vandy.model.Palantir> palantiri) {
        ...
        mPalantiriMap = new HashMap<edu.vandy.model.Palantir, Boolean>();
        for (edu.vandy.model.Palantir palantir : palantiri) {
     ...
     * available.
     */
    public edu.vandy.model.Palantir acquire() {
        ...
        synchronized (mPalantiriMap) {
            for (Map.Entry<edu.vandy.model.Palantir,Boolean> entry : mPalantiriMap.entrySet()) {
     ...
     */
    public void release(final edu.vandy.model.Palantir palantir) {
